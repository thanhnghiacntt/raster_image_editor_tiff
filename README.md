...
3. **Bước 1** – chọn file ảnh → *Nạp ảnh*. Ảnh thường hiện giữa khung nhìn; ảnh đã có tọa độ (GeoTIFF, world file) được đặt thẳng vào đúng vị trí.
...
6. **Bước 4** – chọn **hệ tọa độ đầu ra** (vd. EPSG:4326 hay EPSG:3857), đường dẫn `.tif` → **XUẤT GEOTIFF**.
